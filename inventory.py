...
def read_shoes_data():
    try: # The use of try/except statements will make sure that if the file is not found, an appropriate message will be printed.
        inventory = open(r'C:\Users\dlami\Desktop\Hyperion\L1T30\L1T30\inventory.txt', 'r')
...
def capture_shoes():
    ...
    inventory = open(r'C:\Users\dlami\Desktop\Hyperion\L1T30\L1T30\inventory.txt', 'w')
...
def view_all():
    ...
    print(tabulate(str_shoe_list,headers = head))
